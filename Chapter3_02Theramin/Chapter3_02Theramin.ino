/* Trinket Theremin
Read the voltage from a Cadmium Sulfide (CdS) photocell voltage divider and output a 
corresponding tone to a piezo buzzer

From Chapter 3 of Getting Started with Trinket by Michael J Barela, 2014  
